 ...
 * 
 * @see com.pojo.Goodtype
 * @author MyEclipse Persistence Tools
 */
@Transactional
public class GoodtypeDAO {
	private static final Logger log = LoggerFactory
			.getLogger(GoodtypeDAO.class);
	// property constants
	public static final String TYPENAME = "typename";
	public static final String TYPEDESCR = "typedescr";
	...
	public Goodtype findById(java.lang.Integer id) {
		...
		try {
			Goodtype instance = (Goodtype) getCurrentSession().get(
					"com.pojo.Goodtype", id);
			return instance;
		} catch (RuntimeException re) {
	...
	{
		try {
			String queryString = "from Goodtype as model where model.typename like ?";
	...
	public List findByExample(Goodtype instance) {
		...
		try {
			List results = getCurrentSession()
					.createCriteria("com.pojo.Goodtype")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Goodtype instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from Goodtype as model where model."
					+ propertyName + "= ?";
			Query queryObject = getCurrentSession().createQuery(queryString);
			queryObject.setParameter(0, value);
			return queryObject.list();
	...
	public List findByTypedescr(Object typedescr) {
		return findByProperty(TYPEDESCR, typedescr);
	}
	...
	public Goodtype merge(Goodtype detachedInstance) {
		...
		try {
			Goodtype result = (Goodtype) getCurrentSession().merge(
					detachedInstance);

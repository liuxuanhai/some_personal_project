...
<div class="header">
	<div class="header-top">
 	...
 	<div class="content">
		...
		<form id="addform" action="servlet/luntanhuatiAddServlet" method="post" enctype="multipart/form-data" class="definewidth m10">
		<input class="hide" name="username" value="${sessionScope.spotuser.username }"/>	
                 <div class="m20">游记标题<input type="text" name="title" id="title" class="form-control"/></div>
	                    <div  class="m10">
						游记内容编辑区
						<div>
						...
						<div class="text-center m20">
						 <button type="submit" class="btn btn-primary" onclick="return onadd()">发表</button> 
						</div>
						<div class="m20"></div>
						<div class="m20"></div>
						<div class="m20"></div> 

	...
	<div class="header-top">
 	...
 	<div class="content">
		...
		<div class="form-inline" style="padding:10px;">
			...
			&nbsp;&nbsp;
			<input type="button" class="btn btn-success" value="发表游记" onclick="onfabiaohuati()"/>
			</div>
		</div>
		<div style="padding:10px;">
		
		<table style="table-layout:fixed" width="90%">
		<c:forEach items="${sessionScope.luntanhuatilist}" var="info">
			<tr class="text-left" height="30px">
				<td  style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis;width:80%">
				<a href="luntanhuati.do?method=luntanhuatiLookExecute&luntanhuatiid=<c:out value="${info.id}"/>">
				<c:out value="${info.title}"/></a></td>
				<td><c:out value="${info.addtime}"/></td>
			</tr>
		</c:forEach>
		</table>
		</div>
...
function onfabiaohuati()
{
	...
	window.location.href="luntanhuatiadd.jsp";
}

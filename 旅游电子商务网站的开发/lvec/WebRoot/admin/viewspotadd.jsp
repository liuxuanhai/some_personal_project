...
<body>
<form action="../servlet/viewspotAddServlet" enctype="multipart/form-data" method="post" class="definewidth m20" onsubmit="return validate_info(this);">
<table class="table table-bordered table-hover definewidth m10">
    <tr>
        <td width="15%" class="tableleft">景点名称</td>
        <td><input type="text" id="spotname" name="spotname"  value="" class="form-control" /></td>
    </tr>
    <tr>
        <td class="tableleft">景点城市</td>
        <td><input type="text" id="spotcity" name="spotcity" value="" class="form-control"/></td>
    </tr>
    
    <tr>
        <td class="tableleft">详细地址</td>
        <td><input type="text" id="spotaddr" name="spotaddr" value="" class="form-control"/></td>
    </tr>
	<tr>
        <td class="tableleft">门票(元/张)</td>
        <td><input type="text" id="spotprice" name="spotprice" value="" class="form-control"  onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();"/></td>
    </tr>
	<tr>

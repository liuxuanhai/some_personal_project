...
<body>
<form action="../servlet/goodinfoAddServlet" enctype="multipart/form-data" method="post" class="definewidth m20" onsubmit="return validate_info(this);">
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td><input type="text" id="goodname" name="goodname" value="" class="form-control"/></td>
    </tr>
    
    <tr>
        <td class="tableleft">产品描述</td>
        <td>
        <textarea rows="3" id="gooddescr" name="gooddescr" cols="" class="form-control"></textarea>
        </td>
    </tr>
	<tr>
        <td class="tableleft">产品单价(元)</td>
        <td><input type="text" id="goodprice" name="goodprice" value="" class="form-control"  onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();"/></td>
    </tr>
	<tr>
        <td class="tableleft">库存量</td>
        <td>
        <input type="text" id="goodnum" name="goodnum" value="" class="form-control"  onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();"/>
        </td>
    </tr>
    <tr>

...
<div class="m20">
	...
	<table style="table-layout:fixed;width:90%" >
	        ...
	        <tr class="text-left" height="30px">
				...
				<a target="_brank" href="qiantai.do?method=ptzhaopinLookExecute&ptzhaopinid=<c:out value="${ptzhaopin.id}"/>">
				<c:out value="${ptzhaopin.title}"/></a></td>
				<td><c:out value="${ptzhaopin.addtime}"/></td>
			</tr>
			</c:forEach>
	</table>
	</div>
...
function onprevious()
{
	...
	window.location.href="qiantai.do?method=ptzhaopinIndexExecute&findinfo="+encodeURI(encodeURI($("#findinfo").val()))+"&pagenumber="+pagenumber;
}
function onnext()
{
...
$(function () {
	...
	window.location.href="qiantai.do?method=ptzhaopinIndexExecute&findinfo="+encodeURI(encodeURI($("#findinfo").val()));
	});
  });
</script>
...
<div class="m10" style="border:1px solid #ccc;">
	<div class="text-center m10"><h2>${sessionScope.gonggaolook.title}</h2></div>
	<div class="text-center">
	<hr />
	<small>
	发布时间:<em>${sessionScope.gonggaolook.addtime}</em>&nbsp;&nbsp;&nbsp;&nbsp;浏览量:<em>${sessionScope.gonggaolook.looknum}</em>
	</small></div>
	
	<div class="row">
	 <div class="col-md-10 col-md-offset-1">
 	<div class="m20">
	${sessionScope.gonggaolook.content}
 	</div>
 	<div class="m20" >
 		<h4 class="title">附件</h4>
 		<c:set var="filepathlist" value="${fn:split(sessionScope.gonggaolook.filepath, '#')}" />
 		<c:set var="filenamelist" value="${fn:split(sessionScope.gonggaolook.filename, '#')}" />

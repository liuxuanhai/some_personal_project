      ...
      <nav class="navbar navbar-default" >
          ...
          <div id="navbar" class="navbar-collapse collapse" style="font-size: 18px;">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="qiantai.do?method=gonggaoIndexExecute">新闻公告</a></li>
...
<div class="m20">
	...
	<table style="table-layout:fixed;width:90%" >
	        ...
	        <tr class="text-left" height="30px">
				...
				<a target="_brank" href="qiantai.do?method=gonggaoLookExecute&gonggaoid=<c:out value="${gonggao.id}"/>">
				<c:out value="${gonggao.title}"/></a></td>
...
function onprevious()
{
	...
	window.location.href="qiantai.do?method=gonggaoIndexExecute&findinfo="+encodeURI(encodeURI($("#findinfo").val()))+"&pagenumber="+pagenumber;
}
function onnext()
{
...
$(function () {
	...
	window.location.href="qiantai.do?method=gonggaoIndexExecute&findinfo="+encodeURI(encodeURI($("#findinfo").val()));
	});
  });
</script>
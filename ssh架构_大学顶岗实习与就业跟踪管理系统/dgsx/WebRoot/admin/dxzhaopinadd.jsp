...
<body>
<form id="addform" action="../dxzhaopin.do?method=dxzhaopinAddExecute" method="post" class="definewidth m20" >
...
<div class="120">
参与单位
<textarea rows="2" cols="" class="form-control" id="cydw" name="cydw"></textarea>
</div>

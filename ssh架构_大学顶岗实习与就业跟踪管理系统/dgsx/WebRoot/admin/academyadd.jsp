...
<body>
<form id="addform" action="../academy.do?method=academyAddExecute" method="post" class="definewidth m20" >
<table class="table table-bordered table-hover definewidth m10">
    <tr>
        <td width="20%" class="tableleft">院系名称</td>
        <td><input type="text" id="academyname" name="academyname" class="form-control"/></td>
    </tr>
    <tr>
        <td class="tableleft">院系简介</td>
        <td>
        <textarea rows="4" cols="" id="academydescr" name="academydescr" class="form-control"></textarea>
        </td>
    </tr>

...
<input type="hidden" value="${sessionScope.gonggaomodifyinfo.id}" name="gonggaoid"/>
<div class="text-center m10"><h3>通知公告添加</h3></div>
<div class="m20">
公告标题
<input type="text" id="title" name="title" class="form-control" value="${sessionScope.gonggaomodifyinfo.title}"/>
</div>
<div  class="m20">
公告内容编辑区
<div>
<script id="editor" type="text/plain" style="width:100%;height:300px;" name="content">${sessionScope.gonggaomodifyinfo.content}</script>
</div>
</div>
<div class="m20">
<div class="form-inline m30">
附件&nbsp;&nbsp;<div class="radio">
		   <label>
		   <input type="radio" name="fujian" value="是" checked  />保留原有附件
		   </label>&nbsp;&nbsp;
		   <label>
		   <input type="radio" name="fujian" value="否"  />删除原有附件
		   </label>
	    </div>
</div>
<div class="form">

...
<caption class="text-center">${sessionScope.stuclassroom.classname}-学生列表
...
function onfind()
{
	window.location.href="../student.do?method=studentFindByClassIDExecute&classid="+$("#classid").val()+"&findinfo="+encodeURI(encodeURI($("#findinfo").val()));
}
function onback()
{
	window.location.href="../classroom.do?method=classroomFindExecute&academyid="+$("#academyid").val();
}
function onprevious()
{
	...
	window.location.href="../student.do?method=studentFindByClassIDExecute&classid="+$("#classid").val()+"&findinfo="+encodeURI(encodeURI($("#findinfo").val()))+"&pagenumber="+pagenumber;
}
function onnext()
{

...
<body>
<form id="addform" action="../student.do?method=studentModifyExecute" method="post" class="definewidth m20" >
<table class="table table-bordered table-hover definewidth m10">
    <tr>
        <td width="20%" class="tableleft">学号</td>
        <td width="80%"><input type="text" id="stuid" name="stuid" style="width:300px;" value="${sessionScope.studentmodifyinfo.stuid}" readonly/></td>
    </tr>
    <tr>
        <td class="tableleft">姓名</td>
        <td>
        <input type="text" id="name" name="name" style="width:300px;" value="${sessionScope.studentmodifyinfo.name}"/>
        </td>
    </tr>
	...
	<tr>
        ...
        <div class="radio">
		   ...
		   <input type="hidden" value="${sessionScope.studentmodifyinfo.sex}" id="hidesex"/>
	    </div>
        </td>
    </tr>
	<tr>
        ...
        <input type="hidden" value="${sessionScope.studentmodifyinfo.classroom.academy.academyid}" id="hideacademy"/>
        </td>
    </tr>
    <tr>
        ...
        <input type="hidden" value="${sessionScope.studentmodifyinfo.classroom.classid}" id="hideclassroom"/>
        </td>
    </tr>
    <tr>
        <td class="tableleft">电话</td>
        <td>
        <input type="text" value="${sessionScope.studentmodifyinfo.phone}" id="phone" name="phone" style="width:300px;" placeholder="11位手机号" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();"/>
        </td>
    </tr>
    <tr>
        <td class="tableleft">身份证</td>
        <td>
        <input type="text" value="${sessionScope.studentmodifyinfo.idcard}" id="idcard" name="idcard" style="width:300px;" placeholder="15位或18位" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();"/>
        </td>
    </tr>
    <tr>
    
        <td class="tableleft">入学日期</td>
        <c:set var="stringtime" value="${fn:split(sessionScope.studentmodifyinfo.schooltime, ' ')}" />
        <td>
    ...
    <tr>
        ...
        <td>
        <input type="text" id="qqid" name="qqid" value="${sessionScope.studentmodifyinfo.qqid}" style="width:300px;" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();"/>
        </td>
    </tr>
    <tr>
...
<script>
	...
	function getAcademyClassroomCallbackinit(data)
	{
		$("#classroom").html(""); 
		for(var i=0;i<data.length;++i)
			$("#classroom").append("<option value='"+data[i][0]+"'>"+data[i][1]+"</option>");
		$("#classroom").val($("#hideclassroom").val());
	}
    $(function () {       
		...
		student.getAcademyClassroom($("#academy").val(),getAcademyClassroomCallbackinit);
    });
